...
type SelectTab = 'basic' | 'variants' | 'features' | 'multiselect';
    ...
    <div class="space-y-6">
      ...
      <div role="tablist" class="tabs tabs-boxed w-fit">
        ...
        <button
          role="tab"
          class="tab"
          [class.tab-active]="activeTab() === 'multiselect'"
          (click)="activeTab.set('multiselect')"
        >
          Multiselect
        </button>
      </div>
...
export class SelectDemoComponent {
  activeTab = signal<SelectTab>('basic');
