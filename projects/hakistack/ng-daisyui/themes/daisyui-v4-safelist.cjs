/**
 * @hakistack/ng-daisyui-v4 - Tailwind CSS Safelist (CommonJS)
 *
...
const safelist = [
  // DaisyUI Components - Alert (v4: no alert-soft)
  'alert', 'alert-success', 'alert-info', 'alert-warning', 'alert-error',
  ...
  // DaisyUI Components - Card (v4: no card-bordered, use border utility)
  'card', 'card-body', 'card-title', 'card-compact', 'card-actions', 'card-side',
  ...
  'tab', 'tabs', 'tabs-lifted', 'tab-active', 'tab-disabled', 'tab-border-none',
