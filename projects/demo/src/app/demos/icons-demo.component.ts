    ...
    <div class="space-y-6">
      ...
      <div role="tablist" class="tabs tabs-box">
        ...
        <input
          ...
          (change)="activeTab.set('categories')"
        />
        <input
          type="radio"
          name="icons_tabs"
          ...
          [checked]="activeTab() === 'playground'"
          (change)="activeTab.set('playground')"
        />
      </div>
          ...
          <div class="card bg-base-100 shadow-xl">
            <div class="card-body">
              ...
              <div class="flex items-center gap-6">
                ...
                <app-lucide-icon name="Heart" [size]="32" color="oklch(0.7 0.25 330)" />
