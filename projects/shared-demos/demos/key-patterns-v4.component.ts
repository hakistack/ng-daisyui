...
/**
 * V4 variant of KeyPatternsComponent.
 * Content is framework-agnostic (library patterns apply to both v4 and v5 consumers).
 * Differences from the v5 variant are cosmetic: DaisyUI v5-only class names
 * (badge-soft, card-border, card-sm/xs, alert-soft, tabs-box, timeline-compact)
 * have been swapped for their v4 equivalents so the page renders correctly on
 * DaisyUI 4 + Tailwind 3.
 */
@Component({
  ...
  template: `
    <div class="space-y-10 max-w-4xl">
      ...
      <div class="space-y-2">
        ...
        <p class="text-base-content/60 text-sm leading-relaxed max-w-2xl">
          Understand the design decisions behind ng-daisyui -- the why, not just the how. These patterns apply identically on v4 and v5.
        </p>
      </div>
      ...
      <div class="card bg-base-200 compact">
        <div class="card-body">
          <h3 class="text-xs font-semibold uppercase tracking-wider text-base-content/50 mb-2">On this page</h3>
          <ul class="space-y-1">
      ...
      <section id="builders" class="space-y-6 scroll-mt-20">
        ...
        <div tabindex="0" class="collapse collapse-arrow bg-base-100 border-base-300 border">
          ...
          <div class="collapse-content text-sm text-base-content/70 leading-relaxed space-y-2">
          ...
          <div class="collapse-content">
            <div class="flex flex-wrap gap-2 pt-1">
              @for (ft of fieldTypes; track ft) {
                <span class="badge badge-outline badge-sm font-mono">field.{{ ft }}()</span>
              }
            </div>
          </div>
        </div>
      ...
      <section id="form-controller" class="space-y-6 scroll-mt-20">
        <div class="flex items-start gap-4">
          ...
          <div>
            ...
            <p class="text-sm text-base-content/60 mt-1">Forms render fields. You own the buttons.</p>
          </div>
        </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
              @for (ex of controllerExamples; track ex.title) {
                <div class="bg-base-200 rounded-box p-4 space-y-2">
                  ...
                  <p class="text-xs text-base-content/55 leading-relaxed">{{ ex.desc }}</p>
                </div>
              }
            </div>
          </div>
        ...
        <div tabindex="0" class="collapse collapse-arrow bg-base-100 border-base-300 border">
          ...
          <div class="collapse-content text-sm text-base-content/70 leading-relaxed space-y-2">
            <p>
              ...
              <code class="text-xs bg-base-300 px-1.5 py-0.5 rounded">count-distinct</code>.
            </p>
            ...
            <div class="grid grid-cols-2 gap-2 pt-1">
              @for (util of treeUtils; track util.name) {
                <div class="text-xs">
                  ...
                  <span class="text-base-content/55 ml-1">{{ util.desc }}</span>
                </div>
              }
            </div>
          </div>
      ...
      <section id="services" class="space-y-6 scroll-mt-20">
        <div class="flex items-start gap-4">
          ...
          <div>
            ...
            <p class="text-sm text-base-content/60 mt-1">ToastService, AlertService, DialogService -- imperative APIs for feedback.</p>
          </div>
        </div>
          ...
          <div class="collapse-content">
            <div class="flex flex-wrap gap-2 pt-1">
              @for (m of alertMethods; track m) {
                <span class="badge badge-outline badge-sm font-mono">alert.{{ m }}()</span>
              }
            </div>
          </div>
        </div>
      ...
      <section id="standalone" class="space-y-6 scroll-mt-20">
        <div class="flex items-start gap-4">
          ...
          <div>
            ...
            <p class="text-sm text-base-content/60 mt-1">No NgModules. OnPush + signals everywhere. Zero boilerplate.</p>
          </div>
        </div>
...
export class KeyPatternsV4Component {
...
export const appConfig = {
  providers: [
    provideHkTheme('daisyui-v4'),    // v4-compatible markup
    provideToast(),
    provideAlert(),
...
// Or with the dynamic directive (requires LucideDynamicIcon in imports):
