...
import { LucideIconComponent } from '@hakistack/ng-daisyui-v3';
    ...
    <div class="drawer lg:drawer-open min-h-screen bg-base-200">
      ...
      <div class="drawer-content">
        ...
        <div class="navbar bg-base-100 lg:hidden sticky top-0 z-30 shadow-sm">
          ...
          <span class="text-xl font-bold">ng-daisyui-v3</span>
        </div>
      ...
      <div class="drawer-side z-40">
        ...
        <aside class="bg-base-100 w-72 min-h-full border-r border-base-300">
          ...
          <div class="p-4 border-b border-base-300">
            <h1 class="text-2xl font-bold text-primary">ng-daisyui-v3</h1>
